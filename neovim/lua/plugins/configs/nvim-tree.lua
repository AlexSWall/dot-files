...
function M.setup()
	...
	nmap('<Leader>nh', function() require('nvim-tree.view').resize('-10') end, 'Reduce nvim-tree width')
	nmap('<Leader>nl', function() require('nvim-tree.view').resize('+10') end, 'Increase nvim-tree width')
