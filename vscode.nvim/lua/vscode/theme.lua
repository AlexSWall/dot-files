...
theme.load_syntax = function()
	...
	local syntax = {
		...
		CursorLine = { nil, c.vscHoverText, 'none', nil },
		...
		Folded = { c.vscLeftLight, c.vscBack, 'none', nil },
		...
		MatchParen = { c.vscPink, c.vscBack, 'none', nil },
		...
		StatusLine = { c.vscStatusForeground, c.vscStatusBackground, 'none', nil },
		StatusLineNC = { c.vscStatusNCForeground, c.vscBack, 'none', nil },
		...
		Comment = { c.vscGray, nil, isItalic and 'italic' or 'none', nil },
		Constant = { c.vscBlue, nil, 'none', nil },
		String = { c.vscGreen, nil, 'none', nil },
		Character = { c.vscGreen, nil, 'none', nil },
		Number = { c.vscOrange, nil, 'none', nil },
		...
		SpecialComment = { c.vscGray, nil, 'none', nil },
		...
		TSStringRegex = { c.vscGreen, nil, 'none', nil },
		TSString = { c.vscGreen, nil, 'none', nil },
		TSCharacter = { c.vscGreen, nil, 'none', nil },
		TSNumber = { c.vscOrange, nil, 'none', nil },
		...
		TSFuncBuiltin = { c.vscYellowOrange, nil, 'none', nil },
		...
		TSText = { c.vscLightGray, nil, 'none', nil },
		TSUnderline = { c.vscLightGray, nil, 'none', nil },
		...
		-- Nvim-cmp ghost text
		CmpGhostText = { c.vscGray, nil, 'none', nil },

		-- Rainbow brackets
		rainbowcol1 = { c.vscLightRed, c.vscBack, 'none', nil },
		rainbowcol2 = { c.vscOrange, c.vscBack, 'none', nil },
		rainbowcol3 = { c.vscPink, c.vscBack, 'none', nil },
		rainbowcol4 = { c.vscGreen, c.vscBack, 'none', nil },
		rainbowcol5 = { c.vscYellow, c.vscBack, 'none', nil },
		rainbowcol6 = { c.vscBlue, c.vscBack, 'none', nil },
		rainbowcol7 = { c.vscViolet, c.vscBack, 'none', nil },
	}
